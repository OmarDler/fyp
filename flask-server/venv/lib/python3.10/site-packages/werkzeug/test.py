...
def stream_encode_multipart(
    ...
    for key, value in _iter_data(data):
        ...
        if reader is not None:
            ...
            write_binary(
                encoder.send_event(
                    Data(data=value.encode(charset), more_data=False))
            )
...
class EnvironBuilder:
    ...
    def __init__(
        ...
        run_once: bool = False,
        headers: t.Optional[t.Union[Headers,
                                    t.Iterable[t.Tuple[str, str]]]] = None,
        data: t.Optional[
    ...
    def _add_file_from_data(
        ...
        key: str,
        value: t.Union[
            t.IO[bytes], t.Tuple[t.IO[bytes],
                                 str], t.Tuple[t.IO[bytes], str, str]
        ],
    ) -> None:
